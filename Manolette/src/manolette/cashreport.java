...
public class cashreport extends javax.swing.JFrame {
 Connection conn = null;
    ...
    private void initComponents() {
        ...
        cash.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Date", "Product Name", "Expenses", "Prices", "Net Income"
            }
        ));
        ...
        jPanel1.add(jLabel9, new org.netbeans.lib.awtextra.AbsoluteConstraints(240, 580, -1, 30));
        ...
        jPanel1.add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(660, 10, 30, 40));
 ...
 EXPENSEREPORT s= new  EXPENSEREPORT();
  ...
  retrieve();
    int sum = 0;
        for (int i=0; i<cash.getRowCount(); i++)
        {
            sum = sum + Integer.parseInt(cash.getValueAt(i,7).toString());
        }
...
private void retrieve() {
    try {
        String sql = "SELECT date AS 'Date', p_name AS 'Product Name',p_category AS 'Category',p_prices AS 'Prices', p_expenses AS 'Expenses',p_netincome as 'Net Income',p_quantity AS 'Quantity',totalcost AS 'Total Cost' FROM transaction";
       ...
       try {
       String sql = "SELECT date AS 'Date', p_name AS 'Product Name',p_category AS 'Category',p_prices AS 'Prices', p_expenses AS 'Expenses',p_netincome as 'Net Income',p_quantity AS 'Quantity',totalcost AS 'Total Cost' FROM transaction WHERE MONTH(date) = 1";
               pst = conn.prepareStatement(sql);
                rs = pst.executeQuery();
                cash.setModel(DbUtils.resultSetToTableModel(rs));
                          int sum = 0;
   ...
   private void february(){
      try {
       String sql = "SELECT date AS 'Date', p_name AS 'Product Name',p_category AS 'Category',p_prices AS 'Prices', p_expenses AS 'Expenses',p_netincome as 'Net Income',p_quantity AS 'Quantity',totalcost AS 'Total Cost' FROM transaction WHERE MONTH(date) = 2";
               pst = conn.prepareStatement(sql);
                rs = pst.executeQuery();
                cash.setModel(DbUtils.resultSetToTableModel(rs));
                          int sum = 0;
    ...
    private void march(){
        try {
         String sql = "SELECT date AS 'Date', p_name AS 'Product Name',p_category AS 'Category',p_prices AS 'Prices', p_expenses AS 'Expenses',p_netincome as 'Net Income',p_quantity AS 'Quantity',totalcost AS 'Total Cost' FROM transaction WHERE MONTH(date) = 3";
               pst = conn.prepareStatement(sql);
                rs = pst.executeQuery();
                cash.setModel(DbUtils.resultSetToTableModel(rs));
                          int sum = 0;
     ...
     private void april(){
          try {
         String sql = "SELECT date AS 'Date', p_name AS 'Product Name',p_category AS 'Category',p_prices AS 'Prices', p_expenses AS 'Expenses',p_netincome as 'Net Income',p_quantity AS 'Quantity',totalcost AS 'Total Cost' FROM transaction WHERE MONTH(date) = 4";
               pst = conn.prepareStatement(sql);
                rs = pst.executeQuery();
                cash.setModel(DbUtils.resultSetToTableModel(rs));
                          int sum = 0;
      ...
      private void may(){
             try {
         String sql = "SELECT date AS 'Date', p_name AS 'Product Name',p_category AS 'Category',p_prices AS 'Prices', p_expenses AS 'Expenses',p_netincome as 'Net Income',p_quantity AS 'Quantity',totalcost AS 'Total Cost' FROM transaction WHERE MONTH(date) = 5";
               pst = conn.prepareStatement(sql);
                rs = pst.executeQuery();
                cash.setModel(DbUtils.resultSetToTableModel(rs));
                          int sum = 0;
       ...
       private void june(){
          try {
         String sql = "SELECT date AS 'Date', p_name AS 'Product Name',p_category AS 'Category',p_prices AS 'Prices', p_expenses AS 'Expenses',p_netincome as 'Net Income',p_quantity AS 'Quantity',totalcost AS 'Total Cost' FROM transaction WHERE MONTH(date) = 6";
               pst = conn.prepareStatement(sql);
                rs = pst.executeQuery();
                cash.setModel(DbUtils.resultSetToTableModel(rs));
                          int sum = 0;
        ...
        private void july(){
        try {
         String sql = "SELECT date AS 'Date', p_name AS 'Product Name',p_category AS 'Category',p_prices AS 'Prices', p_expenses AS 'Expenses',p_netincome as 'Net Income',p_quantity AS 'Quantity',totalcost AS 'Total Cost' FROM transaction WHERE MONTH(date) = 7";
               pst = conn.prepareStatement(sql);
                rs = pst.executeQuery();
                cash.setModel(DbUtils.resultSetToTableModel(rs));
                          int sum = 0;
        ...
        total.setText(Integer.toString(sum));
         ...
         private void august(){
         try {
         String sql = "SELECT date AS 'Date', p_name AS 'Product Name',p_category AS 'Category',p_prices AS 'Prices', p_expenses AS 'Expenses',p_netincome as 'Net Income',p_quantity AS 'Quantity',totalcost AS 'Total Cost' FROM transaction WHERE MONTH(date) = 8";
               pst = conn.prepareStatement(sql);
                rs = pst.executeQuery();
                cash.setModel(DbUtils.resultSetToTableModel(rs));
                          int sum = 0;
        ...
        total.setText(Integer.toString(sum));
          ...
          private void september(){
           try {
         String sql = "SELECT date AS 'Date', p_name AS 'Product Name',p_category AS 'Category',p_prices AS 'Prices', p_expenses AS 'Expenses',p_netincome as 'Net Income',p_quantity AS 'Quantity',totalcost AS 'Total Cost' FROM transaction WHERE MONTH(date) = 9";
               pst = conn.prepareStatement(sql);
                rs = pst.executeQuery();
                cash.setModel(DbUtils.resultSetToTableModel(rs));
                          int sum = 0;
        ...
        total.setText(Integer.toString(sum));
           ...
           try {
         String sql = "SELECT date AS 'Date', p_name AS 'Product Name',p_category AS 'Category',p_prices AS 'Prices', p_expenses AS 'Expenses',p_netincome as 'Net Income',p_quantity AS 'Quantity',totalcost AS 'Total Cost' FROM transaction WHERE MONTH(date) = 10";
               pst = conn.prepareStatement(sql);
                rs = pst.executeQuery();
                cash.setModel(DbUtils.resultSetToTableModel(rs));
                          int sum = 0;
        ...
        try {
         String sql = "SELECT date AS 'Date', p_name AS 'Product Name',p_category AS 'Category',p_prices AS 'Prices', p_expenses AS 'Expenses',p_netincome as 'Net Income',p_quantity AS 'Quantity',totalcost AS 'Total Cost' FROM transaction WHERE MONTH(date) = 11";
               pst = conn.prepareStatement(sql);
                rs = pst.executeQuery();
                cash.setModel(DbUtils.resultSetToTableModel(rs));
                          int sum = 0;
       ...
       try {
         String sql = "SELECT date AS 'Date', p_name AS 'Product Name',p_category AS 'Category',p_prices AS 'Prices', p_expenses AS 'Expenses',p_netincome as 'Net Income',p_quantity AS 'Quantity',totalcost AS 'Total Cost' FROM transaction WHERE MONTH(date) = 12";
               pst = conn.prepareStatement(sql);
                rs = pst.executeQuery();
                cash.setModel(DbUtils.resultSetToTableModel(rs));
                          int sum = 0;
