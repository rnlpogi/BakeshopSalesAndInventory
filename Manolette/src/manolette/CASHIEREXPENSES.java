 ...
 * @author khen
 */
public class CASHIEREXPENSES extends javax.swing.JFrame {
   Connection conn = null;
    PreparedStatement pst = null;
    ResultSet rs;
    DefaultTableModel model;
    public CASHIEREXPENSES() {
        initComponents();
    }
 ...
 for (int i=0; i<EXP.getRowCount(); i++)
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CASHIEREXPENSES.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new CASHIEREXPENSES().setVisible(true);
            }
        });
    }
