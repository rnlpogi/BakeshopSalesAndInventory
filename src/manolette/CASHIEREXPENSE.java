 ...
 * @author ADMIN
 */
public class CASHIEREXPENSE extends javax.swing.JFrame {
  ...
  Connection conn = null;
    ...
    private void initComponents() {
        ...
        jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/manolette/icons8-logout-28.png"))); // NOI18N
        jLabel2.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                jLabel2MouseClicked(evt);
            }
        });
        jPanel2.add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(670, 10, 30, 40));
        ...
        EXP.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
        ...
        jPanel1.add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(60, 130, 590, 500));
        jPanel1.add(total, new org.netbeans.lib.awtextra.AbsoluteConstraints(380, 650, 140, 30));

        jLabel9.setFont(new java.awt.Font("Times New Roman", 1, 14)); // NOI18N
        jLabel9.setText("Total Expenses:");
        jPanel1.add(jLabel9, new org.netbeans.lib.awtextra.AbsoluteConstraints(250, 650, -1, 30));
 ...
 for (int i=0; i<EXP.getRowCount(); i++)
        {
            sum = sum + Integer.parseInt(EXP.getValueAt(i,2).toString());
        }
        total.setText(Integer.toString(sum));// TODO add your handling code here:
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CASHIEREXPENSE.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new CASHIEREXPENSE().setVisible(true);
            }
        });
    }

    // Variables declaration - do not modify//GEN-BEGIN:variables
    private javax.swing.JTable EXP;
...
private void retrieve() {
    try {
        String sql = "SELECT date AS 'Date', p_name AS 'Product Name', p_expenses AS 'Expenses' FROM transaction WHERE date = CURDATE()";
        pst = conn.prepareStatement(sql);
        rs = pst.executeQuery();
        EXP.setModel(DbUtils.resultSetToTableModel(rs));
    } catch (Exception e) {
